...
class WelcomeScreen: UIView {
    ...
    private func configConstraints() {
        ...
        entryButton.anchor(top: descriptionLabel.bottomAnchor, leading: leadingAnchor, trailing: trailingAnchor, padding: UIEdgeInsets(top: 170, left: 20, bottom: 0, right: 20), size: CGSize(width: 0, height: 40))
